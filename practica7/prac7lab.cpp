...
GLfloat MercuryDiffuse[] = { 1.0f, 1.0f, 1.0f, .0f };			
GLfloat MercurySpecular[] = { 2.0, 2.5, 2.5, 1.0 };
GLfloat MercuryShininess[] = { 50.0 };

GLfloat VenusDiffuse[] = { 0.97f, 0.95f, 0.7f, 1.0f };			
